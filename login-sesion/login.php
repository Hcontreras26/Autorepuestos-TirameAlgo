...
<body class="bg-pattern transition-colors duration-200">
    ...
    <nav class="bg-custom-wineDeep backdrop-blur-sm dark:bg-custom-wineDeep text-white px-6 py-4 flex justify-between items-center fixed w-full top-0 z-50 shadow-lg">
        <div>
            <a href="../index.php"
    ...
    <main class="min-h-screen flex flex-col items-center justify-center px-4 relative z-10">
        <div class="bg-custom-silverLight dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full">
            <!-- Alerta de Error -->
            ...
            <form class="space-y-6" action="../logica/loguear.php" method="POST">
                <div class="space-y-4">
                    <div>
                        <label for="username" class="block text-sm font-medium text-custom-black dark:text-gray-200 mb-1">
                            Correo Electrónico
                        </label>
                        <input
                            type="email"
                            ...
                            name="username"
                            required
                            class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:border-custom-red dark:focus:border-red-500 dark:bg-gray-700 dark:text-white"
                        >
                    </div>
                    <div>
                        <label for="password" class="block text-sm font-medium text-custom-black dark:text-gray-200 mb-1">
                            Contraseña
                        </label>
                        <input
                            type="password"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        class="text-sm text-custom-red dark:text-red-400 hover:underline">
                            ¿Eres cliente?
                        </a>
            ...
            <div class="mt-4 text-center">
                <a href="../index.php" class="text-custom-red-light dark:text-red-light-400 hover:underline text-sm">
                    Volver al inicio
                </a>
            </div>
        </div>
