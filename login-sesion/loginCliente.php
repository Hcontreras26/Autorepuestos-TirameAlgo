...
<body class="bg-pattern transition-colors duration-200">
    ...
    <main class="min-h-screen flex flex-col items-center justify-center px-4 relative z-10">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-md w-full">
            ...
            <h2 class="text-2xl font-bold text-custom-red dark:text-white text-center mb-6">
                Iniciar Sesión
            </h2>
            <form class="space-y-6" action="../logica/loguear-cliente.php" method="POST">
                ...
                <button
                    type="submit"
                    class="w-full bg-custom-orange hover:bg-wineDark dark:bg-custom-orange
            ...
            <div class="mt-4 text-center">
                <a href="../index.php" class="text-custom-red dark:text-red-400 hover:underline text-sm">
                    Volver al inicio
                </a>
            </div>
        </div>
