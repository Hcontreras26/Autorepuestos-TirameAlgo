...
<body class="bg-pattern transition-colors duration-200">
    ...
    <!-- Sidebar -->
    <div class="fixed left-0 top-16 h-full w-64 bg-custom-red/95 backdrop-blur-sm dark:bg-custom-red-800/95 shadow-lg">
        <div class="p-4">
            <nav class="space-y-2">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded-md transition-colors duration-200">
                                                Editar
                                            </a>
                                        </div>
                                    </td>
